...
.box__face {
  position: absolute;
  border: 1px solid rgba(26,84,105,.5);
  border-radius: 0px;
...
.box__face--back {
  width: 100%;
  height: var(--height);
  background-image: linear-gradient(rgba(0, 77, 71, 0.3) 1px, transparent 1px),linear-gradient(90deg, rgba(0, 77, 71, 0.3) 1px, transparent 1px);
...
.box__face--left {
  ...
  background-image: linear-gradient(transparent 90%, rgba(26,84,105,.5));
...
.box__face--top {
  position: absolute;
  background-image: linear-gradient(to right, transparent 90%, rgba(26,84,105,.5));
...
.box__face--back { transform: rotateY(180deg) translateZ(var(--depthTransform)); }
.box__face--right { transform: rotateY(90deg) translateZ(var(--depthTransform)); }
.box__face--left { transform: rotateY(-90deg) translateZ(var(--depthTransform)); }
.box__face--top { transform: rotateX(90deg) translateZ(var(--depthTransform)); }
.box__face--bottom { transform: rotateX(-90deg) translateZ(var(--depthTransform)); }
